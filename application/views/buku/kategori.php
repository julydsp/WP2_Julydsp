                    ...
                    foreach ($kategori as $k) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('buku/hapuskategori/') . $k['id_kategori']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $k['role']; ?>?');" class="badge badge-danger"><i class="fas fa-trash"></i>Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
